...
<meta name="csrf-token" content="{{ csrf_token() }}">
 <h1 class="titulo bloqueo"> Editar Bloqueo </h1>
  ...
  <div class="content">
     ...
     <form action="{{URL::current()}}">
      <div class="col-lg-12" style="margin-bottom: 2em;">
        ...
        <div class="col-lg-6">
          Tipo de Habitación: {{$bloqueo->habitacione->habitaciontipo->nombre}} <br/>
          Fecha Inicio: {{$bloqueo->fechainicio}}<br/>
       </div>
       <div class="col-lg-6">
       Número de Habitacion: {{$bloqueo->habitacione->numero}} <br/>
        Fecha Fin: {{$bloqueo->fechafin}}<br/>
     </div>
             ...
             <div class="col-lg-12">
              ...
              <form class="form-horizontal" role="form" method="POST" action="{{ route('bloqueos.update', $bloqueo->id ) }}" enctype="multipart/form-data">
