...
<meta name="csrf-token" content="{{ csrf_token() }}">
 <h1 class="titulo reserva"> Agregar Húesped a la Reserva </h1>


  <div class="content">

         <form class="form-horizontal" role="form" method="POST" action="{{ url('reservaentidadadd') }}" enctype="multipart/form-data">
             {{ csrf_field() }}
        ...
        <div class="col-lg-12">
          ...
          <!--  end true -->
             ...
             <div class="col-lg-5">
               ...
               <input type="hidden" name="reservacion_habitacione_id" value="{{$id}}">
