...
<form class="form-horizontal" role="form" method="POST" action="{{ url('tarifaadd') }}" enctype="multipart/form-data">
 {{ csrf_field() }}

<h1 class="titulo habitacion"> Agregar Tarifa </h1>
